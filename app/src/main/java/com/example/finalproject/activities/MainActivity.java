...
import com.example.finalproject.adapters.RecentConversionsAdapter;
import com.example.finalproject.databinding.ActivityMainBinding;
import com.example.finalproject.listeners.ConversionListener;
...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void init(){
        ...
        binding.conversioonsRecyclerView.setAdapter(conversionsAdapter);
    ...
    private void listeneConverations(){
    ...
    private final EventListener<QuerySnapshot> eventListener =(value, error) ->{
        ...
        if (value != null){
            ...
            binding.conversioonsRecyclerView.smoothScrollToPosition(0);
            binding.conversioonsRecyclerView.setVisibility(View.VISIBLE);

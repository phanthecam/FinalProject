...
private void listenMessage(){
        ...
        if(value != null){
            ...
            for(DocumentChange documentChange : value.getDocumentChanges()){
                if(documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    chatMessage.dateTime = getReadablleDateTime(documentChange.getDocument().getDate(Constants.KEY_TIMESTAMP));
    ...
    private String getReadablleDateTime(Date date){
    ...
    private void checkForeConversion(){
